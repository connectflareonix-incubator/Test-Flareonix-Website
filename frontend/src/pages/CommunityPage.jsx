        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Whether you're building the next big startup or mastering freelancing, 
              Flareonix has a home for you.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="p-6 glass rounded-xl border border-white/10 text-center"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              {founderBenefits.map((benefit, index) => (
                <div
                  key={benefit.title}
                  className="p-4 glass rounded-xl border border-white/10 hover:border-primary/30 transition-all"
                >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              {freelancerBenefits.map((benefit, index) => (
                <div
                  key={benefit.title}
                  className="p-4 glass rounded-xl border border-white/10 hover:border-accent/30 transition-all"
                >
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="p-6 glass rounded-2xl border border-primary/30"
            >
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "You think long-term wealth building"
                ].map((item, i) => (
            ...
            <motion.div
              ...
              className="p-6 glass rounded-2xl border border-accent/30"
            >
              <h3 className="font-heading text-xl font-bold text-accent mb-4">Freelancers Community</h3>
              <ul className="space-y-3">
                {[
                  "You have a skill to offer",
                  "You want to earn while learning",
                  "You prefer flexibility over equity",
                  "You want quick income results",
                  "You're building towards agency/consulting"
                ].map((item, i) => (
                  <li key={i} className="flex items-center gap-2 text-muted-foreground">
