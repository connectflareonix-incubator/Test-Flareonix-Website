    ...
    <main className="min-h-screen bg-[#050505] flex items-center justify-center px-6">
      ...
      >
        <div className="text-center mb-8">
          <img src={LOGO_URL} alt="Flareonix" className="h-20 w-auto mx-auto mb-6" />
          <h1 className="font-heading text-3xl font-bold text-white mb-2">
            Enter the <span className="text-primary">Fire</span>
          </h1>
        ...
        <div className="p-8 glass rounded-2xl border border-white/10">
          <Button
            onClick={login}
            className="w-full bg-white text-black hover:bg-white/90 rounded-full py-6 text-lg font-semibold mb-4"
